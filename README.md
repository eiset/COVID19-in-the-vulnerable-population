...
- The `covid19.vulnerable.aarhus.Rproj` file dictates that the directory is a RStudio
...
`covid19.vulnerable.aarhus.Rproj` file and running this command in the console:
